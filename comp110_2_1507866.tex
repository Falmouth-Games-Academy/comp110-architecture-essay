...
Sulaiman et al do not give run times for their algorithm. They instead compared it to two existing algorithms. One of which was the GJK  algorithm. They found that their algorithm gave a speed increase  between 78.1\% to 110.9\%. The DyOp algorithm does not provide data on how fast it runs in milliseconds making it hard to compare to the second algorithm. However Guo\textsc{\char13}s algorithm used bounding boxes. Sulaiman et al were aiming to implement an algorithm more accurate than bounding boxes.
